...
DESCRIPTION = 'Load Prediction Model'
URL = 'https://github.com/randi-source'
EMAIL = 'randi.eka1301@gmail.com'
AUTHOR = 'Randi Eka Sanjaya'
...
# Load the package's __version__.py module as dictionaty.
